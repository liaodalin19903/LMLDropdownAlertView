...
let MAIN_COLOR = UIColor(red: 230.0/255.0, green: 60.0/255.0, blue: 22.0/255.0, alpha: 1.0)
...
class LMLDropdownAlertView: UIView {
    ...
    func setupTitleLabel() {
        ...
        titleLabel.textColor = UIColor.colorFromRGB(rgbValue: 0xffffff)
    ...
    func setupSubtitleTextView() {
        ...
        subTitleTextView.font = UIFont(name: "Helvetica", size:15)
    ...
    func resizeAndRelayout() {
        ...
        if self.titleLabel.text != nil {
            //titleLabel.frame = CGRect(x: x, y: y, width: width, height: title_height)
            titleLabel.frame = CGRect(x: 0, y: 0, width: content_width, height: title_height)
            contentView.addSubview(titleLabel)
        ...
        if self.subTitleTextView.text.isEmpty == false {
            ...
            tv_height = ceil(rect.size.height) + 10.0
        ...
        if btnArr.count == 2 {
            ...
            button_one.frame = CGRect.init(x: 0, y: y + 4, width: content_width / 2.0 , height: btn_height)
            
            button_one.backgroundColor = UIColor.init(white: 0.9, alpha: 1.0)
            let color_one: UIColor = UIColor.init(white: 0.2, alpha: 1.0)
            //[btn setTitleColor:[UIColor blackColor]forState:UIControlStateNormal];
            button_one.setTitleColor(color_one, for: UIControlState.normal)
            button_one.titleLabel?.font = UIFont(name: "Helvetica", size:16)
            
            button_two.frame = CGRect.init(x: content_width / 2.0, y: y + 4, width: content_width / 2.0 , height: btn_height)
